...
/**
 * Class for iterating over a statement and returning one array with related objects at a time
 *
 * @author     sven.syld@brainart.ee
 * @package    propel.runtime.collection
 */
class PropelOnDemandArrayCollection extends PropelCollection
{
	/**
	 * @var       PropelOnDemandArrayIterator
	 */
	protected $iterator;
	...
	{
		$this->iterator = new PropelOnDemandArrayIterator($formatter, $stmt);
	}
